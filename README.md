...
tern code install db/core --config setup/postgres/tern.conf
...
```
docker run -it -v /path-to-project/setup/postgres/tern.conf:/migrations/tern.conf -e TERN_CONFIG=/migrations/tern.conf entigolabs/waypoint-db:latest
```
